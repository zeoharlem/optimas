...
<footer class="footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3">
                ...
                <div class="footer-contacts">
                    <p class="footer-contacts__address">no 21, goshen house apapa, lagos</p>
                    <p class="footer-contacts__phone">Phone: <a href="tel:+31859644725">+31 85 964 47 25</a></p>
                    <p class="footer-contacts__mail">Email: <a href="mailto:support@osmi.com">support@osmi.com</a></p>
                </div>
            </div>
            <div class="col-sm-6 col-lg-3">
        ...
        <div class="row align-items-baseline">
            <div class="col-md-6">
                <p class="footer-copyright">© 2020 osmi</p>
            </div>
            <div class="col-md-6">
